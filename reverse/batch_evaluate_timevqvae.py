#!/usr/bin/env python3
"""
Batch evaluation of TimeVQVAE-AD results from a directory of pickle files.
...
def main():
    parser = argparse.ArgumentParser(description='Batch evaluate TimeVQVAE-AD results from a directory')
    ...
    print("="*80)
    print("TIMEVQVAE-AD BATCH EVALUATION")
    print("="*80)
