...
class MadridClusteredThresholdTradeoffAnalyzerTestOnly:
    ...
    def calculate_responder_analysis(self, patient_stats: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
        """
        Calculate responder analysis for patients.
    ...
    def select_optimal_thresholds(self, training_results: List[Dict[str, Any]]) -> Dict[str, float]:
        ...
        # Find threshold with lowest false alarms per hour (but sensitivity > 5)
    ...
    def run_full_analysis(self, num_thresholds: int = 50):
        ...
        if test_results:
            ...
            if all_subject_metrics:
                ...
                subject_csv_path = self.output_dir / f"madrid_subject_level_metrics_window_{timestamp}.csv"
